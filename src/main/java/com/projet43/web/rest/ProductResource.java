...
import com.projet43.domain.Product;
import com.projet43.repository.ProductRepository;
import com.projet43.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.projet43.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductResource {
    ...
    /**
     * {@code POST  /products} : Creates a new product.
     *
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated product,
     * or with status {@code 400 (Bad Request)} if the product is not valid,
     * or with status {@code 404 (Not Found)} if there is no product with the given ID,
     * or with status {@code 500 (Internal Server Error)} if the product couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        log.debug("REST request to partial update Product : {}, {}", id, product);
        if (product.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                // Category relation is typically not partially updated directly here.
                // If the category itself needs to change, it might require a more explicit
                // DTO or a separate endpoint depending on business logic.
